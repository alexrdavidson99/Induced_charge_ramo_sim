...
#print(f"x = {xi}")
    ...
    grouped_sum.to_csv(f'C:/Users/lexda/PycharmProjects/Induced_charge_ramo_sim/induced_charge_tom_P_1500v_fix_{j-batch_size}_{j}_off_center_z_75.csv', index=False)
